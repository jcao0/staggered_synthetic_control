function [a_hat,b_hat] = synthetic_control(Y)
%SYNTHETIC_CONTROL Synthetic control weights
% In put Y is N by T matrix, where each row is a pre-treatment time series.
