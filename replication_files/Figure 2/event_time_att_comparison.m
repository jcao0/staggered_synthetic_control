...
p1 = errorbar(1:S1,gamma_hat_1,ub_1,-lb_1,...
    'Color',[1,0.4,0.3],'CapSize',10);
p1.LineStyle = 'none';
p2 = errorbar(1:S2,gamma_hat_2,ub_2,-lb_2,...
...
xlim([.5 S+.5])
legend([p3 p4],{'Quota','Disclosure'},'Location','northwest','FontSize',15);
...
saveas(figure(1),'graph2a.png')
saveas(figure(3),'graph2b.png')
